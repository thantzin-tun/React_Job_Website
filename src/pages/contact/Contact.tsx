...
import { Card, FilterBar, TextCom, FilterCom, SearchBarCom, Divider,Loading } from 'components'
      ...
      <div className="container-fluid customPadding">
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className='box my-3 rounded px-4 py-2' style={{
              border: "1px solid #dfdfdf",
            }}>
              <TextCom fontSize="18" color='#3b3b3b' fontWeight="600">Jobs in Myanmar</TextCom>
            </div>
          </div>
        </div>
        ...
        <div className="row m-0 d-flex justify-content-between group">
          <div className="col-lg-9 col-sm-5 col py-2 foundJob">
            <TextCom fontSize="myFont" color='#f57c00' fontWeight="600">1,966 </TextCom>
            <TextCom fontSize="myFont" color='#3b3b3b' fontWeight="600">Jobs Found</TextCom>
          </div>
          <div className="col-md-3 col-sm-5 col filter p-0">
            <div className="filter-group" onClick={() => setActive(true)}>
              ...
              <TextCom marginLeft="8" marginRight="8" fontSize="customSize">Filter</TextCom>
          ...
          <div className="col align-items-center justify-content-end sort">
            <TextCom color='#3b3b3b' fontWeight="600" marginRight="20" fontSize="sm">Sort By: </TextCom>
            <select>
        ...
        <SortingBar hide={hide}>
          <div className='d-flex align-items-center justify-content-between ps-3 pe-4 pb-2'>
            <TextCom fontSize="18" fontWeight="600">FILTER BY:</TextCom>
          ...
          <div className="sortOne" onClick={() => selectSort(1)}
            style={select === 1 ? { backgroundColor: '#f7f7f7' } : {}}
          >
            <TextCom fontSize="14" fontWeight="600" style={{ width: "100px" }}>Recommended</TextCom>
            <i className="fa-solid fa-check fs-6 text-primary ms-5 fw-bold" style={select === 1 ? { display: 'block' } : { display: "none" }}></i>
          </div>
          <div className='sortOne' onClick={() => selectSort(2)}
            style={select === 2 ? { backgroundColor: '#f7f7f7' } : {}}
          >
            <TextCom fontSize="14" fontWeight="600" style={{ width: "100px" }}>Post Date</TextCom>
            <i className="fa-solid fa-check fs-6 text-primary ms-5 fw-bold" style={select === 2 ? { display: 'block' } : { display: "none" }}></i>
          </div>
