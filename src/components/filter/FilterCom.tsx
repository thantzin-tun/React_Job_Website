...
export const FilterCom: React.FC<FilterProps> = ({ mobile, setActive, active }) => {
            ...
            <>
              ...
              <MobileFilterHeader>
                <div className="d-flex align-items-center justify-content-between">
                  <TextCom fontSize="customSize" fontWeight="600">FILTER BY:</TextCom>
                  <div className="close_filterBar">
                    <TextCom color="#007bff"
                      fontSize="xs" hoverColor="#504c4c"
                      onClick={() => dispatch({ type: JobAction.reset, payload: "" })}
                    >Clear All</TextCom>
                    <ButtonCom isBorder={false} bgColor="#1ac880" btnPaddingInline="40" size="13" border_radius="4" btnTextColor="#fff" onClick={() => setActive(!active)}>OK</ButtonCom>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-center justify-content-between mt-4">
                  <TextCom color="#007bff"
                    ...
                    onClick={() => dispatch({ type: JobAction.reset, payload: "" })}
                  >Clear All</TextCom>
                  <ButtonCom isBorder={false} bgColor="#1ac880" size="13" border_radius="4"
                    btnWidth="50%"
                    btnTextColor="#fff"
            ...
            <FilterHeader>
              ...
              <div className="clear">
                <TextCom color="#007bff"
                  ...
                  onClick={() => dispatch({ type: JobAction.reset, payload: "" })}
                >Clear All</TextCom>
                <ButtonCom isBorder={false} bgColor="salaryHover" btnPaddingInline="10" size="13" border_radius="4" btnTextColor="cardBack" onClick={CallingJobSearchApi}>
        ...
        <div className="accordion two" id="accordionPanelsStayOpenExampleTwo">
          ...
          <div className="accordion-item">
            ...
            <div id="panelsStayOpen-collapseOne" className="accordion-collapse collapse">
              <div className="accordion-body">
                <select className="form-select" aria-label="Default select example" onChange={(e) => dispatch({ type: JobAction.freshDate, payload: e.target.value })}
                  value={state.freshDate}
                >
                  <option defaultValue={"Any Days"}>
                    <TextCom color="#495057" fontSize="xs">Any Days</TextCom>
                  </option>
                  <option value={0}>
                    <TextCom color="#495057" fontSize="xs">Today</TextCom>
                  </option>
                  <option value={7}>
                    <TextCom color="#495057" fontSize="xs">Last 7 days</TextCom>
                  </option>
                  <option value={14}>
                    <TextCom color="#495057" fontSize="xs">Last 14 days</TextCom>
                  </option>
                  <option value={30}>
                    <TextCom color="#495057" fontSize="xs">Last 30 days</TextCom>
                  </option>
                </select>
              </div>
            </div>
                  ...
                  <div id="panelsStayOpen-collapseSix" className="accordion-collapse collapse">
                    <div className="accordion-body">
                      ...
                      <div className="check d-flex align-items-center mb-1">
                        <input className="me-2" type="radio" name="flexRadioDefault" id="flexRadioDefault1"
                          onChange={(e) => dispatch({ type: JobAction.category, payload: "" })}
                          defaultChecked
                        />
                        ...
                        getJobCategory_data?.map((category: { id: number, name: string }, index: number) => {
                          return (
                            <div className="check d-flex align-items-center p-0 mb-1">
                              <input className="me-2" type="radio" name="flexRadioDefault7" id="flexRadioDefault7"
                                onChange={(e) => dispatch({ type: JobAction.category, payload: category.id })}
                      ...
                      <div className="check d-flex align-items-center mb-1">
                        <input className="me-2" type="radio" name="flexRadioDefault" id="flexRadioDefault2"
                          onChange={(e) => dispatch({ type: JobAction.category, payload: 1 })}
                        />
                  ...
                  <div id="panelsStayOpen-collapseSeven" className="accordion-collapse collapse">
                    <div className="accordion-body">
                      ...
                      <div className="form-check d-flex align-items-center p-0 mb-0">
                        <input className="me-2" type="radio" name="flexRadioDefault"
                          onChange={(e) => dispatch({ type: JobAction.city, payload: "" })}
                          defaultChecked
                      ...
                      <div className="form-check d-flex align-items-center p-0 mb-0">
                        <input className="me-2" type="radio" name="flexRadioDefault"
                          ...
                          onChange={(e) => dispatch({ type: JobAction.city, payload: 99 })}
                        />
          ...
          <div className="accordion-item">
            ...
            <div id="panelsStayOpen-collapseTwo" className="accordion-collapse collapse">
              <div className="accordion-body">
                ...
                {/* Loop for Industry */}
                <div className="check d-flex align-items-center mb-1">
                  <input className="check me-2" type="radio" name="flexRadioDefault" id="flexRadioDefault5"
                    defaultChecked={state.industry === ""}
                    onChange={() => dispatch({ type: JobAction.industry, payload: "" })}
                  />
                ...
                <div className="check d-flex align-items-center mb-1">
                  <input className="me-2" type="radio" name="flexRadioDefault" id="flexRadioDefault6"
                    onChange={() => dispatch({ type: JobAction.industry, payload: 4 })}
                  />
            ...
            <div id="panelsStayOpen-collapseThree" className="accordion-collapse collapse">
              <div className="accordion-body">
                <select className="form-select" aria-label="Default select example"
                  onChange={(e) => dispatch({ type: JobAction.level, payload: e.target.value })}
                  value={state.level}
                >
                  <option value="">
                    <TextCom>Any</TextCom>
          ...
          <div className="accordion-item">
            ...
            <div id="panelsStayOpen-collapseFour" className="accordion-collapse collapse">
              <div className="accordion-body">
                <input className="form-control" type="number" step="10000" min="0"
                  onChange={(e) => dispatch({ type: JobAction.salary, payload: e.target.value })}
                  value={state.salary}
                ></input>
              </div>
            </div>
