...
export const SearchBarCom: React.FC<SearchBarProps> = () => {
  ...
  return (
    <>
      <SearchBarContainer style={scrollPositionStyle ? { position: 'fixed', top: '0%', left: "0%" } : {}}>
...

          {
            isSearchBarChange
              ...
              <>
                ...
                <SearchBarStyle>
                  <div className="title">
                    ...
                    <input type="text" placeholder='All positions, Companies, Keywords'
                      onChange={(e) => dispatch({ type: JobAction.title, payload: e.target.value })} />
                  </div>
                </SearchBarStyle>
              ...
              <SearchBarStyle>
                ...
                <div className="title">
                  <i className="fa-solid fa-magnifying-glass"></i>
                  <input type="text" placeholder='All positions, Companies, Keywords' onChange={(e) => dispatch({ type: JobAction.title, payload: e.target.value })} />
                </div>
                ...
                <div className="job-function">
                  ...
                  <div className="dropdown w-100">
                    ...
                    <button className="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                      ...
                      <TextCom fontSize="14" fontWeight="600" hoverColor='dropDownHover'
                      >{category}</TextCom>
                      <img src={downArrow} alt="down-arrow" style={{ width: "8px" }} />
                    </button>
                      ...
                      <div className="myDropDown">
                        ...
                        >
                          ...
                          <div className='move d-flex align-items-center'>
                            <TextCom fontSize="13" fontWeight="600" hoverColor='dropDownHover'>All Job Functions</TextCom>
                          </div>
                        </div>
                ...
                <div className="location">
                  <div className="dropdown w-100">
                    ...
                    <button className="btn dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                      ...
                      <TextCom fontSize="13" fontWeight="600" hoverColor='dropDownHover'>
                        {location}
                      </TextCom>
                      <img src={downArrow} alt="down-arrow" style={{ width: "8px" }} />
                    </button>
                    <ul className="dropdown-menu">
                      <div className="myDropDown">
                        ...
                        >
                          <span className='dot'></span>
                          <div className='move d-flex align-items-center'>
                            <TextCom fontSize="13" fontWeight="600" hoverColor='dropDownHover'>All Locations</TextCom>
                          </div>
                        </div>
                  ...
                  getJobCity_data?.map((city: { id: number, name: string }, index: number) => {
                    return (
                      <div className='item d-flex align-items-center justify-content-start'
                        onClick={() => {
                          dispatch({ type: JobAction.city, payload: city.id });
                      ...
                      >
                        <span className='dot'></span>
                        <div className='move d-flex align-items-center'>
                          <TextCom fontSize="13" fontWeight="600" hoverColor='dropDownHover'>{city.name}</TextCom>
                        </div>
                      </div>
                    )
                  })
